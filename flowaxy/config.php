...
return [
    ...
    'contact_email' => flowaxy_env_value('CONTACT_EMAIL', 'contact@roselira.shop'),
    'contact_phone' => flowaxy_env_value('CONTACT_PHONE', '+380966349498'),
    'contact_telegram' => flowaxy_env_value('CONTACT_TELEGRAM'),
    'contact_telegram_url' => flowaxy_env_value('CONTACT_TELEGRAM_URL', 'https://t.me/kikomilanooooo'),
    'business_site_name' => 'roselira.shop',
    'business_legal_name' => 'ФОП Довгопол Микола Іванович',
    'business_tax_id' => '3484109139',
    'business_address' => [
        'м. Суми, Сумська область, Україна',
    ],
