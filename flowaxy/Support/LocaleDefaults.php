...
final class LocaleDefaults
{
    ...
    public static function patchKeys(): array
    {
        return [
            ...
            'footer_email_aria',
            'footer_phone_aria',
            'footer_telegram_aria',
            'footer_support_title',
            'footer_preferred_contact',
            'footer_preferred_contact_method',
            'footer_tax_label',
            'footer_rights',
            'cookie_title',
            'cookie_banner_text',
    ...
    public static function en(): array
    {
        return [
            ...
            'footer_copy' => '© :year Roselira — :legal_name | :tax_label :tax_id. :rights',
            'footer_copy_short' => '© :year :site',
            'footer_nav_label' => 'Footer links',
            'footer_contacts_label' => 'Contact',
            'footer_email_aria' => 'Email',
            'footer_phone_aria' => 'Phone',
            'footer_telegram_aria' => 'Telegram',
            'footer_support_title' => 'Customer support',
            'footer_preferred_contact' => 'Preferred contact method: :method',
            'footer_preferred_contact_method' => 'Email',
            'footer_tax_label' => 'Tax ID',
    ...
    public static function uk(): array
    {
        return [
            ...
            'footer_contacts_label' => 'Контакти',
            'footer_email_aria' => 'Написати на email',
            'footer_phone_aria' => 'Зателефонувати',
            'footer_telegram_aria' => 'Telegram-канал',
            'footer_support_title' => 'Служба підтримки клієнтів',
            'footer_preferred_contact' => 'Пріоритетний спосіб зв\'язку: :method',
            'footer_preferred_contact_method' => 'Електронна адреса',
            'footer_tax_label' => 'РНОКПП',
    ...
    public static function ru(): array
    {
        return [
            ...
            'footer_phone_aria' => 'Позвонить',
            'footer_telegram_aria' => 'Telegram-канал',
            'footer_support_title' => 'Служба поддержки клиентов',
            'footer_preferred_contact' => 'Приоритетный способ связи: :method',
            'footer_preferred_contact_method' => 'Электронная почта',
            'footer_tax_label' => 'ИНН',
